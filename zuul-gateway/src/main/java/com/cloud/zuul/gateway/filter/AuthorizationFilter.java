package com.cloud.zuul.gateway.filter;
...
//            ctx.setResponseBody(new Gson().toJson( new ErrorMsg(Error.AUTHORIZATION_FAILED_EXCEPTION,"Authorization failed!")));// 返回错误内容
